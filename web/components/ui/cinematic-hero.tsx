...
export function CinematicHero({ 
  ...
  useEffect(() => {
    ...
    const progressOffset = 402 - (402 * metricValue / metricMax);
    ...
    const ctx = gsap.context(() => {
      ...
      scrollTl
        ...
        .to(".progress-ring", { strokeDashoffset: progressOffset, duration: 2, ease: "power3.inOut" }, "-=1.2")
        ...
        >
          ...
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 py-6 lg:py-0">
            ...
            <div className="card-right-text gsap-reveal order-1 lg:order-3 flex justify-center lg:justify-end z-20 w-full">
              <h2 className="text-4xl md:text-[5rem] lg:text-[7rem] font-black uppercase tracking-tighter text-card-silver-matte lg:mt-0 leading-[0.85]">
                {brandName}
              </h2>
            </div>
